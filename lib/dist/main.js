...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Array.prototype.forEach.call(document.querySelectorAll(".pgc-calendar-wrapper"), function (calendarWrapper, calendarCounter) {
        ...
        // height = auto: calendat will grow in height (dayMaxEventRows/dayMaxEvents is ignored)
        var defaultConfig = {
            //height: "auto", // this will cause the calendar to grow to fit the content.
            //aspectRatio: 1,
            locale: locale,
            dayMaxEvents: true, // This will cause to display + more links if events don't fit
            navLinks: true
        };
