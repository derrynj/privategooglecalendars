        ...
        config = Object.assign(config, {
            ...
            eventDidMount: function (info) {
                ...
                if (showEventPopup) {
					...
					// If location is a valid URL, create a hyperlink
					texts.push('<div class="pgc-popup-row pgc-event-location"><div class="pgc-popup-row-icon"><span class="dashicons dashicons-location"></span></div><div class="pgc-popup-row-value"><a target="_blank" href="' + location + '">' + location + '</a></div></div>');
					} else {
					// If location is not a valid URL, display as plain text
					texts.push('<div class="pgc-popup-row pgc-event-location"><div class="pgc-popup-row-icon"><span class="dashicons dashicons-location"></span></div><div class="pgc-popup-row-value">' + location + '</div></div>');
						}
